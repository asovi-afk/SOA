...
class NotificationResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:notify.NotificationResponse) */ {
 public:
  ...
  inline void CopyFrom(const NotificationResponse& from) {
